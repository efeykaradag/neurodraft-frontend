...
export default function FileGrid({
    ...
    // Tüm türler için Quick Look: zip/pdf'de backend'den blob, diğerlerinde local yol
    const handleQuickLook = async (file: UploadedFile) => {
        // Sadece PDF veya ZIP dosyaları için blob'dan göster
        if (file.filetype?.includes("pdf") || file.filename.endsWith(".zip")) {
            try {
        ...
        <>
                        ...
                        files.map((file) => (
                            ...
                            >
                                ...
                                <div className="absolute bottom-3 right-4 flex gap-2">
                                    {/* Quick Look butonu tüm dosyalar için tek fonksiyona bağlı */}
                                    <button
            ...
            <AnimatePresence>
                {previewFile && (
                    ...
                    >
                        <motion.div
                            className="bg-[#232338] rounded-2xl shadow-2xl p-7 max-w-200 w-full mx-4 relative"
                        ...
                        >
                            ...
                            <div className="text-xs text-gray-400 mb-4">
                                {new Date(previewFile.uploaded_at).toLocaleString()} | {previewFile.type}
                            </div>
                            ...
                            {previewFile.type?.startsWith("audio/") && (
                                <audio controls className="w-full my-6">
                                    <source src={getFileUrl(previewFile)} type={previewFile.type} />
